            ...
            <mu-list-item  nested :open="open === index">
                ...
                <mu-list-item-content @click="toggleShow(index)">
                    <mu-list-item-title class="wall_title">
                        ...
                        {{item.guanxianmingcheng}}-{{item.dijingbianhao}}
                    </mu-list-item-title>
                ...
                <mu-list-item-action>
                    ...
                    <router-link style="margin-left:25px;" :to="{path:'/manholeDetail',query:{id:item.id}}">详情</router-link>
...
export default {
    ...
    methods:{
        ...
        loadData(){
            ...
            params.append("wellname",this.search);
