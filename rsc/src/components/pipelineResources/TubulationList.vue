      ...
      <mu-list toggle-nested >
          ...
          <template v-for="(item,index) in data" >
            ...
            <mu-list-item  nested :open="open === index">
                ...
                <!-- 定位 -->
                <mu-list-item-action @click="showTubulationInMap(item.id)" style="margin-right:20px;">
...
export default {
    ...
    methods:{
        ...
        loadData(){
            ...
            params.append("shebeimiaoshu",this.search);
        ...
        showTubulationInMap(id){
            var type = 'tubulation'
            window.mapifram.gisParams.ziYuanLocation(id,7,0,type);
