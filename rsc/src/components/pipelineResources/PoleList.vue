      ...
      <mu-list toggle-nested >
          ...
          <div v-for="(item,index) in data" :key="index">
            ...
            <mu-list-item  nested :open="open === index">
                ...
                <!-- 定位 -->
                <mu-list-item-action @click="showPoleInMap(item.id)" style="margin-right:20px;">
                ...
                <mu-list-item-action>
                    ...
                    <router-link style="margin-left:25px;" :to="{path:'/poleDetail',query:{id:item.id}}">详情</router-link>
                ...
                <mu-list-item button  slot="nested" style="background:#F5F5F5;">
                    <mu-list-item-title>
                            <mu-row  class="wall_item">
                                <mu-col span="16">电杆类型|{{item.buildingType}}</mu-col>
                            
                                <mu-col span="6">电杆类别|{{item.buildingCategory}}</mu-col>
                            </mu-row>
                    </mu-list-item-title>
                </mu-list-item>
...
export default {
    ...
    methods:{
        ...
        loadData(){
            ...
            params.append("polename",this.search);
        ...
        showPoleInMap(id){
            window.mapifram.gisParams.ziYuanLocation(id,4);
