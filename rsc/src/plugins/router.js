...
import CableDetail from "@/components/pipelineResources/CableDetail";
//光缆
...
//电缆
import ElectricCableList from "@/components/pipelineResources/ElectricCableList";
import ElectricCableDetail from "@/components/pipelineResources/ElectricCableDetail";

//周边搜索资源页面
import PeripheralResources from "@/components/gis/PeripheralResources";
...
export default new Router({
  ...
  routes: [{
    ...
    {
      path: '/peripheralResources',
      name: 'peripheralResources',
      component: PeripheralResources,
      props: (route) => ({ data: route.query.data,type:route.query.type}) ,
    },
    {
      path: '/manholeDetail',
      name: 'manholeDetail',
    ...
    //电缆详情
    {
      path: '/electricCableDetail',
      name: 'electricCableDetail',
      component: ElectricCableDetail,
      props: (route) => ({ id: route.query.id }) ,
    },
    {
      path: '/secInfo',
    ...
    },
    {
      ...
      props: (route) => ({ landuanId: route.query.landuanId })
    },
    //光缆段
    {
    ...
    },
    {
      ...
      children: [
        ...
        //电缆
        { path: '/electricCableList',name: 'electricCableList',component:ElectricCableList,props: (route) => ({type: route.query.type,search: route.query.search})},
      ],
    },
    {
      path: '/odfPostDetail',
...

    {
      ...
      props: (route) => ({ id: route.query.id,idx:route.query.idx}),
      redirect:'copticalfiberIndex',
      children:[
        {path:'/copticalfiberIndex',name:'copticalfiberIndex',component:OpticalfiberIndex,props: (route) => ({ id: route.query.id}),},
        {path:'/cpassive',name:'cpassive',component:Passive,props: (route) => ({ id: route.query.id}),},
        {path:'/cactiveDeviceInfo',name:'cactiveDeviceInfo',component:ActiveDeviceInfo,props: (route) => ({ id: route.query.id}),}
      ] 
    },
